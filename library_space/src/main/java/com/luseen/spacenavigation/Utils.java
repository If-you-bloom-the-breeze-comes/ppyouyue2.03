...
class Utils {
     ...
     */
    static void changeImageViewTint(int position, ImageView imageView, int color) {
     ...
     * @param color     tint color
     */
    static void changeImageViewTintClick(int position, ImageView imageView, int color) {
        //   imageView.setColorFilter(color);
